...
Navigator.prototype.LeftArrow  = "&lt;";
Navigator.prototype.RightArrow = "&gt;";
...
// for overwrite
Navigator.prototype.numberElement = function (num) {
  return num;
}
...
Navigator.prototype._build = function () {
  ...
  for (var i = start ; i <= end ; i++) {
    var span = document.createElement("span");
    span._number = i;
    span.innerHTML = this.numberElement(i);
    span.onclick = function () {
      var n = this._number;
      myObj.current(n);
      myObj.onMove(n);}
  ...
  var span = document.createElement("span");
  span.innerHTML = this.RightArrow;
